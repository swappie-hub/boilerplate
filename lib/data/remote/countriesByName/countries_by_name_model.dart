...
//
//     final getCountriesByNameResponse = getCountriesByNameResponseFromJson(jsonString);

import 'dart:convert';

List<GetCountriesByNameResponse> getCountriesByNameResponseFromJson(String str) => List<GetCountriesByNameResponse>.from(json.decode(str).map((x) => GetCountriesByNameResponse.fromJson(x)));

String getCountriesByNameResponseToJson(List<GetCountriesByNameResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetCountriesByNameResponse {
    GetCountriesByNameResponse({
        this.name,
        this.topLevelDomain,
        this.alpha2Code,
        this.alpha3Code,
    ...
    factory GetCountriesByNameResponse.fromJson(Map<String, dynamic> json) => GetCountriesByNameResponse(
        name: json["name"],
